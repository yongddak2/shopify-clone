package com.pantrka.backend.domain.product.service;

import com.pantrka.backend.domain.product.dto.CategoryResponse;
import com.pantrka.backend.domain.product.dto.ProductDetailResponse;
import com.pantrka.backend.domain.product.dto.ProductSummaryResponse;
import com.pantrka.backend.domain.product.entity.Category;
import com.pantrka.backend.domain.product.entity.Product;
import com.pantrka.backend.domain.product.entity.ProductStatus;
import com.pantrka.backend.domain.product.repository.CategoryRepository;
